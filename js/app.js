...
app.getRSS = function (url, targetId, scrollerId) {
    ...
    $.ajax({
        ...
        complete: function (data) {
            ...
            if (json.channel && json.channel[0].item) {
        ...
        error: function (data) {
            ...
            console.warn(json.error, json.error[0].Text);

            if (json.error[0].Text) {
                html += '<li><span>' + json.error[0].Text + '</span></li>';
            }
...
app.init = function () {
    ...
    app.carousels['content'].panelCount = 10;
    app.carousels['content'].modify();
...
app.maximize = function (ev, idx, carouselId) {
    ...
    if (carousel.maximized !== true) {
        ...
        carousel.prevStyle.zIndex = cStyle.zIndex;
        ...
        document.getElementById(cids[cid]).style.zIndex = '200';
        ...
        document.getElementById(cids[cid]).style.zIndex = carousel.prevStyle.zIndex;
